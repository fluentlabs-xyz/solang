...
use crate::{build_solidity_for_fluentbase,build_solidity_with_options};
...
fn try_catch_reachable() {
    ...
    let _ = build_solidity_for_fluentbase(
        r##"
...
contract Flagger {
    ...
    let mut runtime = build_solidity_for_fluentbase(src);
