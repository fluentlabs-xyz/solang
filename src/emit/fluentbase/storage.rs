...
use crate::emit::fluentbase::{log_return_code};
use crate::emit::storage::StorageSlot;
use crate::emit::TargetRuntime;
use crate::emit_fluentbase_context;
...
use crate::emit::fluentbase::FluentbaseTarget;

impl StorageSlot for FluentbaseTarget {
    fn set_storage(
        &self,
        binary: &Binary,
        slot: PointerValue,
